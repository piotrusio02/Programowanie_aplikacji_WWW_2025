<!-- 
Moduł obsługujący zarządzanie kategoriami oraz podkategoriami.
Wyświetla listę w formie drzewa kategorii. Pozwala na dodanie, edycję,
oraz usunięcie kategorii lub podkategorii
-->
...
<?php           
    ...
    */
    function PokazKategorie($link) {
        ...
        echo '<div class="panel-sklep">';

        echo '<h2 class="naglowek-kategorie" onclick="toggleManagera()">
    ...
    */
    function UsunKategorie($link, $id) {
        ...
        $query_delete = "DELETE FROM kategorie WHERE id = $id OR matka = $id LIMIT 1"; 
