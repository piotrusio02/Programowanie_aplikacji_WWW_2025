...
<?php
include ('cfg.php');         // Łączenie z stałymi
...
// Adres admina, odbiera wiadomości z formularza.
...
function PokazKontakt(): void
{
    ...
    // Zabezpieczenie URL akcji formularza.
    $action_url = "?id={$id_kontaktu}"; 

    $komunikat = '';

    // Sprawdzenie i wyświetlenie komunikatu po wysłaniu maila.
...
function WyslijMailKontakt(string $odbiorca): void
{
    ...
    // Przekierowanie do strony kontaktu po wysłaniu formularza.
